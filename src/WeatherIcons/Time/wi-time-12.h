...
//  first 64K of FLASH.
//
//  Data is from file '..\Processed\Time\wi-time-12.bmp'.
//

const byte wi_time_12_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x7d, 
	0x00, 0x7d, 
	0x00, 0x7d, 
...
}; // 125x125 Bitmap (15625 pixels) in 891 bytes

const uint16_t wi_time_12_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_wi_time_12_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(wi_time_12_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(wi_time_12_RLEBM_palette);
	bmInfo.width = 125;
	bmInfo.height = 125;
	bmInfo.flags = 0x01;
}
