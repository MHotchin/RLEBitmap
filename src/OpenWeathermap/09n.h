...
//  first 64K of FLASH.
//
//  Data is from file 'Processed\09n.bmp'.
//

const byte 09n_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x64, 
	0x00, 0x64, 
	0x00, 0x64, 
...
const uint16_t 09n_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_09n_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(09n_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(09n_RLEBM_palette);
	bmInfo.width = 100;
	bmInfo.height = 100;
	bmInfo.flags = 0x01;
}
