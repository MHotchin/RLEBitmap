...
//  first 64K of FLASH.
//
//  Data is from file '128x128\day\Processed\368.bmp'.
//

const byte 368_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x80, 
	0x00, 0x80, 
	0x00, 0x80, 
...
const uint16_t 368_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_368_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(368_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(368_RLEBM_palette);
	bmInfo.width = 128;
	bmInfo.height = 128;
	bmInfo.flags = 0x01;
}
