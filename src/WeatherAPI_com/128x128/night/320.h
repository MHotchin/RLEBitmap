...
//  first 64K of FLASH.
//
//  Data is from file '128x128\night\Processed\320.bmp'.
//

const byte 320_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x80, 
	0x00, 0x80, 
	0x00, 0x80, 
...
const uint16_t 320_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_320_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(320_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(320_RLEBM_palette);
	bmInfo.width = 128;
	bmInfo.height = 128;
	bmInfo.flags = 0x01;
}
