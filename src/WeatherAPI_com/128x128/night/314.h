...
//  first 64K of FLASH.
//
//  Data is from file '128x128\night\Processed\314.bmp'.
//

const byte 314_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x80, 
	0x00, 0x80, 
	0x00, 0x80, 
...
const uint16_t 314_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_314_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(314_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(314_RLEBM_palette);
	bmInfo.width = 128;
	bmInfo.height = 128;
	bmInfo.flags = 0x01;
}
