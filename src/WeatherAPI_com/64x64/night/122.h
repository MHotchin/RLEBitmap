...
//  first 64K of FLASH.
//
//  Data is from file '64x64\night\Processed\122.bmp'.
//

const byte 122_RLEBM_data[] PROGMEM_LATE = 
{
	0x00, 0x40, 
	0x00, 0x40, 
	0x00, 0x40, 
...
}; // 64x64 Bitmap (4096 pixels) in 363 bytes

const uint16_t 122_RLEBM_palette[] PROGMEM_LATE = 
{
...
inline void get_122_RLEBM(
	RLEBitmapInfo &bmInfo)
{
	bmInfo.pRLEBM_data_far = pgm_get_far_address(122_RLEBM_data);
	bmInfo.pRLEBM_palette_far = pgm_get_far_address(122_RLEBM_palette);
	bmInfo.width = 64;
	bmInfo.height = 64;
	bmInfo.flags = 0x01;
}
